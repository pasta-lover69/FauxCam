...
const MESSAGE_REQUEST = "VCAM_REQUEST_IMAGE";
const MESSAGE_RESPONSE = "VCAM_IMAGE_RESPONSE";
const STORAGE_KEY_IMAGE = "vcam_image_data_url";
const STORAGE_KEY_ENABLED = "vcam_enabled";
